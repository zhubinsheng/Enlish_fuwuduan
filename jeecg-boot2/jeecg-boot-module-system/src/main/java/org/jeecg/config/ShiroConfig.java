...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		// 配置不会被拦截的链接 顺序判断
		filterChainDefinitionMap.put("/demo/learningSit/*", "anon");
		filterChainDefinitionMap.put("/api/upload", "anon");
		filterChainDefinitionMap.put("/lib/library/*", "anon");
		filterChainDefinitionMap.put("/api/registerInfo", "anon");
		...
		filterChainDefinitionMap.put("/api/register","anon"); //注册接口排除
